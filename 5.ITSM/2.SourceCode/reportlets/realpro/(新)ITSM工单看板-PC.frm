...
<TableDataMap>
<TableData name="工单时间类型" class="com.fr.data.impl.DBTableData">
<Parameters/>
...
<Query>
<![CDATA[
SELECT  SUM(A.bngdl)  bngdl,SUM(A.sbngdl) sbngdl, 

        SUM(A.sygdl)  sygdl,SUM(A.ssygdl) ssygdl,

        SUM(A.bygdl)  bygdl,SUM(A.sbygdl) sbygdl,

        SUM(A.bzgdl)  bzgdl,SUM(A.sbzgdl) sbzgdl,

        SUM(A.brgdl)  brgdl,SUM(A.sbrgdl) sbrgdl

FROM 
(SELECT case  when  times_type='本年' then  sum(this_gdl)  end  as  bngdl
      ,case  when  times_type='本年' then  sum(last_gdl)  end  as  sbngdl
      ,case  when  times_type='上月' then  sum(this_gdl)  end  as  sygdl
      ,case  when  times_type='上月' then  sum(last_gdl)  end  as  ssygdl
      ,case  when  times_type='本月' then  sum(this_gdl)  end  as  bygdl
      ,case  when  times_type='本月' then  sum(last_gdl)  end  as  sbygdl
      ,case  when  times_type='本周' then  sum(this_gdl)  end  as  bzgdl
      ,case  when  times_type='本周' then  sum(last_gdl)  end  as  sbzgdl
      ,case  when  times_type='本日' then  sum(this_gdl)  end  as  brgdl
      ,case  when  times_type='本日' then  sum(last_gdl)  end  as  sbrgdl
FROM   [ETL_GDQYFX_GDQS]A
GROUP  BY  times_type)  A]]></Query>
</TableData>
<TableData name="工单等级数量" class="com.fr.data.impl.DBTableData">
<Parameters>
<Parameter>
...
<Query>
<![CDATA[ SELECT [times_type]A
      ,[P1]A+[P2]A+[P3]A+[P4]A+[P5]A+[UNKNOWN]A as 工单量
      ,[P1]A
      ,[P2]A
      ,[P3]A
      ,[P4]A
      ...
      ,[S微信]A
      ,[S其他]A
 FROM [ETL_GDDYFX_GDFLFX]A
 WHERE 1=1 ${if(len(times_type)==0,"","and times_type='"+times_type+"'")}]]></Query>
</TableData>
...
<Query>
<![CDATA[select* from (SELECT top 8 * FROM(
		SELECT  
...
<TableData name="工单时间分析" class="com.fr.data.impl.DBTableData">
<Parameters>
<Parameter>
<Attributes name="times_type"/>
<O>
...
<TableData name="工单分类分析-系统" class="com.fr.data.impl.DBTableData">
<Parameters>
<Parameter>
<Attributes name="times_type"/>
<O>
...
<![CDATA[SELECT * FROM(
		SELECT   top 8 [times_type]A
		      ...
		      ,sum([未解决]A)   未解决
		      ,sum([工单量]A)   工单量
		      ,CAST(CAST(sum([解决]A) as FLOAT)/sum([工单量]A) AS decimal(18,4)) AS 解决率
		FROM [V_GDQYFX_GDFLZB]A
		 WHERE 1=1 ${if(len(times_type)==0,"","and times_type='"+times_type+"'")}
		 GROUP  BY  [times_type]A
		      ,[SERVICE_CATEGORY_LV3_NAME]A
		      
		 ORDER BY 工单量 desc
)  as T ORDER BY 工单量 desc]]></Query>
</TableData>
<TableData name="工单分类分析-故障" class="com.fr.data.impl.DBTableData">
<Parameters>
<Parameter>
<Attributes name="times_type"/>
<O>
...
<![CDATA[SELECT * FROM(
		...
		FROM [V_GDQYFX_GDFLZB]A
		 ...
		 GROUP  BY  [times_type]A
		      ...
		      ,CAUSE_CATEGORY_LV1_NAME
		 ORDER BY 工单量 desc
)  as T ORDER BY 工单量 ]]></Query>
</TableData>
<TableData name="工单时间分析-最大值" class="com.fr.data.impl.DBTableData">
<Parameters>
<Parameter>
<Attributes name="times_type"/>
<O>
...
<![CDATA[SELECT 
      ...
      max([this_gdl]A) maxthis
      ,max([last_gdl]A) maxlast
  FROM [ETL_GDQYFX_GDQS]A
  WHERE 1=1 ${if(len(times_type)==0,"","and times_type='"+times_type+"'")}]]></Query>
</TableData>
...
<![CDATA[]]></DSName>
<ColumnNames>
<![CDATA[type,,.,,question_type,,.,,value]]></ColumnNames>
<ColumnTypes>
<![CDATA[java.lang.String,java.lang.String,java.lang.Integer]]></ColumnTypes>
<RowData>
<![CDATA[oC;G^k'T(pp#W88SAl=L4s99Op"Q*UCuR9,j9g&=cufihKdj5_LPrstQuMj*/**V)AL==l<1
+th6.MBlE'8'op13nSQm)oJQiL*>R2J]AVafb%Z]A=2dKEP:#:*lNRY0Jp8s$4dVs).6uk%-GE
;/\(^!i>s_^"S#kt#,Yd@]A*8E]AHti^!JuLL\!rr~
]]></RowData>
</TableData>
...
COUNT(INCIDENT_ID) ORDERS from ITSM_WorkOrder_Sync_test
  WHERE 1=1 and  INCIDENT_STATUS<>7 and   datediff(day,getdate(),REPORT_DATE)=0
...
'已解决' 已解决
 ...
 from ITSM_WorkOrder_Sync_test  where 1=1 and  INCIDENT_STATUS<>7 and datediff(day,getdate(),REPORT_DATE)=-1]]></Query>
</TableData>
...
<Query>
<![CDATA[SELECT Address,sum(A.工单量) AS 工单量 FROM (
SELECT TOP 9
 ...
 WHERE 1=1 and times_type='本月' 
 ORDER BY 工单量 DESC
 )  AS A group by Address ORDER BY 工单量 ASC]]></Query>
</TableData>
...
<Query>
<![CDATA[select convert(datetime,LEFT(CONVERT(NVARCHAR(25),REPORT_DATE,20),13) + ':00:00') 时间,count(INCIDENT_ID) 工单数 from ITSM_WorkOrder_Sync_test 
where 1=1  and  INCIDENT_STATUS<>7 and datediff(day,getdate(),REPORT_DATE)=0
group by convert(datetime,LEFT(CONVERT(NVARCHAR(25),REPORT_DATE,20),13) + ':00:00')
order by convert(datetime,LEFT(CONVERT(NVARCHAR(25),REPORT_DATE,20),13) + ':00:00')
]]></Query>
</TableData>
...
<Query>
<![CDATA[SELECT CONVERT(varchar(100), MAX(report_date),20) as LAST_UPDATETIME FROM [ITSM_WorkOrder_Sync_test]A WHERE INSERTTIME IS NOT NULL]]></Query>
</TableData>
<TableData name="今日工单最大值" class="com.fr.data.impl.DBTableData">
<Parameters/>
<Attributes maxMemRowCount="-1"/>
<Connection class="com.fr.data.impl.NameDatabaseConnection">
<DatabaseName>
...
<![CDATA[SELECT 
      ...
      ,max([last_gdl]A) maxlast
  FROM [ETL_GDQYFX_GDQS]A
  WHERE 1=1 and times_type='本日']]></Query>
</TableData>
<TableData name="工单top5" class="com.fr.data.impl.EmbeddedTableData">
<Parameters/>
<DSName>
<![CDATA[]]></DSName>
<ColumnNames>
<![CDATA[区域,,.,,工单量]]></ColumnNames>
<ColumnTypes>
<![CDATA[java.lang.String,java.lang.Integer]]></ColumnTypes>
<RowData>
<![CDATA[%EQp(6pMFdd-#bjB#Y8AIc.An;I6/`(V:43<C9Bsf=70ni9bVs(ca*4;h3Z$]APe;eT/r8[`"
XH2?WU*EhHic$_ogX6g=d+7m`sqs!BGl#r@uo3P]AeJTYP8f*'O$a#'&S4ZUi$~
]]></RowData>
</TableData>
<TableData name="工单量月度趋势分析" class="com.fr.data.impl.EmbeddedTableData">
<Parameters/>
<DSName>
<![CDATA[]]></DSName>
<ColumnNames>
<![CDATA[年月,,.,,本期,,.,,上期]]></ColumnNames>
<ColumnTypes>
<![CDATA[java.lang.String,java.lang.Integer,java.lang.Integer]]></ColumnTypes>
<RowData>
<![CDATA[29<TC^b?#r^pgpK,VTG>reiXkg3XmcH^R7TNMtgR4%+7`2ZG.$di3>Q2Zc!+7.CE~
]]></RowData>
</TableData>
<TableData name="当月成功登录用户" class="com.fr.data.impl.EmbeddedTableData">
<Parameters/>
<DSName>
<![CDATA[]]></DSName>
<ColumnNames>
<![CDATA[item,,.,,value,,.,,target]]></ColumnNames>
<ColumnTypes>
<![CDATA[java.lang.String,java.lang.Integer,java.lang.Integer]]></ColumnTypes>
<RowData>
<![CDATA[!?D1"s5o-!jbf\nRChRoQ04C1k(pJQ1c@3J#r+7j0JE~
]]></RowData>
</TableData>
<TableData name="年度登录情况占比" class="com.fr.data.impl.EmbeddedTableData">
<Parameters/>
<DSName>
<![CDATA[]]></DSName>
<ColumnNames>
<![CDATA[item,,.,,value]]></ColumnNames>
<ColumnTypes>
<![CDATA[java.lang.String,java.lang.Integer]]></ColumnTypes>
<RowData>
<![CDATA[!?D1"s5geujgq>PRChRoQ0*^QjbC2)NM,F;PR09'0Jr~
]]></RowData>
</TableData>
<TableData name="近12个月登录用户趋势分析" class="com.fr.data.impl.EmbeddedTableData">
<Parameters/>
<DSName>
<![CDATA[]]></DSName>
<ColumnNames>
<![CDATA[年月,,.,,value]]></ColumnNames>
<ColumnTypes>
<![CDATA[java.lang.String,java.lang.Integer]]></ColumnTypes>
<RowData>
<![CDATA[29ErLJ1qN:^piPSdU'@Ns,@$kH&eaG[5(%;=)AXrdiZ4HU$t?6h=77IkfdGQGlR~
]]></RowData>
</TableData>
<TableData name="故障原因分类" class="com.fr.data.impl.EmbeddedTableData">
<Parameters/>
<DSName>
<![CDATA[]]></DSName>
<ColumnNames>
...
<![CDATA[java.lang.String,java.lang.String,java.lang.Integer]]></ColumnTypes>
<RowData>
<![CDATA[FcpN4`%VmZIj_;=UM8HL.FeG:'HE`e&-`_DBGm$`9W5"+P%GM28CQFaq0UE3GO?]Aeg6krN5O
6&[dBAo)TlRb8AF9g!>TtUFf$T)`DTr(g;'JaLFN:FW*=t5>S+8qM0'lmfMTtkM4l*na6$'"
%5b9d1LE&hkp]ATpC`bsZ1[N=^A80UXLohiignGcc9)"jb.JmGXiD$:$JFJ4amPX.H+"Y$dSf
e6pe$cGu0&86;Pj#PTk+(>;Dj8SpM?T/?VQP:@001cB@^k\:[s1113l9:;._FM^(dp.pU\8j
%8ZWX3D&V^g.DV&/u0((4qMqMMhR>fhJE['RYK_-&~
]]></RowData>
</TableData>
<TableData name="工单分类TOP8服务完成情况" class="com.fr.data.impl.EmbeddedTableData">
<Parameters/>
<DSName>
<![CDATA[]]></DSName>
<ColumnNames>
<![CDATA[type,,.,,达标量,,.,,未完成,,.,,完成率]]></ColumnNames>
<ColumnTypes>
<![CDATA[java.lang.String,java.lang.Integer,java.lang.Integer,java.lang.Double]]></ColumnTypes>
<RowData>
<![CDATA[$[)s*FU\\&^3TJEh=EX$9T1u+/3"+2/1aN>\bmJA_T(^b5Ui(>GVDh%TnPM)W=_t^gqq-clc
%`R:Ng[:1c-t@QsjlG`q?]A]AgQUIBJ7?Ng7UQ=Wc-3_GK,+=5dP@"b3A$1LN=A0GND.U-Jq6[
:%e>=BD/%"(BFN<t@:7CBj67Kk'fS#41]AtA._AE7~
]]></RowData>
</TableData>
<TableData name="今日工单未解决情况" class="com.fr.data.impl.EmbeddedTableData">
<Parameters/>
<DSName>
<![CDATA[]]></DSName>
<ColumnNames>
...
<![CDATA[java.lang.String,java.lang.Integer]]></ColumnTypes>
<RowData>
<![CDATA[HT%erC"L5"r>V?sDW.t`HJZ-il'u$T[kE0DUAO28%Zm?W"kSZ(1S8m:p'a5%2rG$d%#?igZ=
=ZsKU3)@]ApufsdgT/+4u1cGdgQ3~
]]></RowData>
</TableData>
<TableData name="KPI" class="com.fr.data.impl.EmbeddedTableData">
<Parameters/>
<DSName>
<![CDATA[]]></DSName>
<ColumnNames>
<![CDATA[yuefen,,.,,VALUE]]></ColumnNames>
<ColumnTypes>
<![CDATA[java.lang.String,java.lang.Integer]]></ColumnTypes>
<RowData>
<![CDATA[1ZUCS1?(.R1?LFP1>t(M1?Gn$1?5_E!!~
]]></RowData>
</TableData>
<TableData name="本日时间分布" class="com.fr.data.impl.DBTableData">
<Parameters/>
<Attributes maxMemRowCount="-1"/>
<Connection class="com.fr.data.impl.NameDatabaseConnection">
<DatabaseName>
...
<TableData name="本年时间分布" class="com.fr.data.impl.DBTableData">
<Parameters/>
<Attributes maxMemRowCount="-1"/>
<Connection class="com.fr.data.impl.NameDatabaseConnection">
<DatabaseName>
...
<![CDATA[SELECT [times_type]A
      ...
      ,[last_gdl]A
  FROM [ETL_GDQYFX_GDQS]A
  WHERE 1=1 and times_type='本年']]></Query>
</TableData>
<TableData name="本月时间分布" class="com.fr.data.impl.DBTableData">
<Parameters/>
<Attributes maxMemRowCount="-1"/>
<Connection class="com.fr.data.impl.NameDatabaseConnection">
<DatabaseName>
...
<![CDATA[SELECT [times_type]A
      ...
      ,[last_gdl]A
  FROM [ETL_GDQYFX_GDQS]A
  WHERE 1=1 and times_type='本月']]></Query>
</TableData>
<TableData name="本月P1问题" class="com.fr.data.impl.DBTableData">
<Parameters/>
<Attributes maxMemRowCount="-1"/>
<Connection class="com.fr.data.impl.NameDatabaseConnection">
<DatabaseName>
...
<Query>
<![CDATA[select count(INCIDENT_ID) AS 工单数 ,
CONVERT(VARCHAR(8),DATEADD(ss,sum(datediff(ss,REGISTER_DATE,SOLUTION_DATE)),'1900-01-01 00:00:00'),108) AS 解决时长,
DATEDIFF(DAY,
(SELECT MAX(REGISTER_DATE) FROM ITSM_WorkOrder_Sync_test WHERE INCIDENT_PRIORITY_NAME = 'P1 危急')
,GETDATE())
 AS 距离发生
from ITSM_WorkOrder_Sync_test where datediff(month, REPORT_DATE, GETDATE())=0
and INCIDENT_PRIORITY_NAME = 'P1 危急']]></Query>
</TableData>
<TableData name="本月P2问题" class="com.fr.data.impl.DBTableData">
<Parameters/>
<Attributes maxMemRowCount="-1"/>
<Connection class="com.fr.data.impl.NameDatabaseConnection">
<DatabaseName>
...
CONVERT(VARCHAR(8),DATEADD(ss,sum(datediff(ss,REGISTER_DATE,SOLUTION_DATE)),'1900-01-01 00:00:00'),108) AS 解决时长,
DATEDIFF(DAY,
(SELECT MAX(REGISTER_DATE) FROM ITSM_WorkOrder_Sync_test WHERE INCIDENT_PRIORITY_NAME = 'P2 高')
,GETDATE())
 AS 距离发生
from ITSM_WorkOrder_Sync_test where datediff(month, REPORT_DATE, GETDATE())=0
and INCIDENT_PRIORITY_NAME = 'P2 高']]></Query>
</TableData>
<TableData name="工单故障分析-月度环比" class="com.fr.data.impl.DBTableData">
<Parameters/>
<Attributes maxMemRowCount="-1"/>
<Connection class="com.fr.data.impl.NameDatabaseConnection">
<DatabaseName>
...
<Query>
<![CDATA[SELECT call_employeecode as employeecode,
		 AddressEn,
		 incident_id AS eventnum,
		 CONVERT(DATETIME, LEFT(CONVERT(NVARCHAR(25), CONVERT(DATETIME,
				 REPORT_DATE),
			 20), 13) + ':00:00') AS TIMES,

		 incident_priority_name AS EmergencyLevel,
		 SERVICE_CATEGORY_LV3_NAME,
		  SERVICE_CATEGORY_LV1_NAME,
		 CAUSE_CATEGORY_LV1_NAME,


		 (CASE WHEN INCIDENT_STATUS=9 or INCIDENT_STATUS=5 THEN '解决'
			 ELSE '未解决'
			 END) AS SolveSLA
			 into #aac
		 FROM itsm_workorder_sync_test left join[dbo]A.[TB_MN_EmployeesInfo]A on call_employeecode = emplid 
		 where  INCIDENT_STATUS<>7
SELECT * FROM (
SELECT 
		 '本月'  times_type,
		 SERVICE_CATEGORY_LV3_NAME,
		 CAUSE_CATEGORY_LV1_NAME,
		 EmergencyLevel,
		 Count(CASE WHEN SERVICE_CATEGORY_LV1_NAME = '故障'
			 THEN eventnum ELSE NULL END) AS 故障,
		 Count(CASE WHEN SERVICE_CATEGORY_LV1_NAME = '请求'
			 THEN eventnum ELSE NULL END) AS 请求,
		 Count(CASE WHEN SERVICE_CATEGORY_LV1_NAME = '事件'
			 THEN eventnum ELSE NULL END) AS 事件,
		 Count(CASE WHEN SERVICE_CATEGORY_LV1_NAME = '其他' or SERVICE_CATEGORY_LV1_NAME IS NULL
			 THEN eventnum ELSE NULL END) AS 未分类,

		 Count(CASE WHEN solvesla = '解决'
			 THEN eventnum ELSE NULL END) AS 解决,
		 Count(CASE WHEN solvesla = '未解决'
			 THEN eventnum ELSE NULL END) AS 未解决,
		 Count(eventnum) AS 工单量
     
	 FROM #aac

	 where   convert(varchar(7),times,121) = convert(varchar(7),getdate(),121)
	    and  convert(varchar(10),times,121)<=convert(varchar(10),DATEADD(day,-0,getdate()),121)
	 GROUP BY 
	  SERVICE_CATEGORY_LV3_NAME,
	  EmergencyLevel,
	  CAUSE_CATEGORY_LV1_NAME
...
SELECT 
	 ...
	 where   convert(varchar(7),times,121) = convert(varchar(7),DATEADD(month,-1,getdate()),121)
	    and  convert(varchar(10),times,121)<=convert(varchar(10),DATEADD(month,-1,getdate()),121)
	 GROUP BY 
	  SERVICE_CATEGORY_LV3_NAME,
	  EmergencyLevel,
	  CAUSE_CATEGORY_LV1_NAME
) AS BBC
inner join   (select  TOP 8 
	RANK()  OVER (ORDER BY count(INCIDENT_ID) DESC)  排名,
	CAUSE_CATEGORY_LV1_NAME from ITSM_WorkOrder_Sync_test   where   convert(varchar(7),REPORT_DATE,121) = convert(varchar(7),getdate(),121)
	    and  convert(varchar(10),REPORT_DATE,121)<=convert(varchar(10),DATEADD(day,-0,getdate()),121)
		group by CAUSE_CATEGORY_LV1_NAME 
		ORDER BY count(INCIDENT_ID) DESC  ) AS CCC on BBC.CAUSE_CATEGORY_LV1_NAME=CCC.CAUSE_CATEGORY_LV1_NAME
 order by  排名 desc , times_type asc
...
<RowPrivilegeControl/>
<RowHeight defaultValue="723900">
<![CDATA[723900,381000,990600,723900,723900,723900,723900,723900,723900,723900,723900]]></RowHeight>
<ColumnWidth defaultValue="2743200">
...
<Margin top="1" left="1" bottom="1" right="1"/>
<Border>
<border style="0" color="-723724" borderRadius="15" type="0" borderStyle="0"/>
<WidgetTitle>
<O>
<![CDATA[新建标题]]></O>
<FRFont name="宋体" style="0" size="72"/>
...
<Style horizontal_alignment="0" vertical_alignment="3" imageLayout="1">
<FRFont name="微软雅黑" style="1" size="176" foreground="-26368"/>
<Background name="ColorBackground" color="-13456165"/>
<Border/>
</Style>
...
<BoundsAttr x="763" y="43" width="222" height="113"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
...
<RowPrivilegeControl/>
<RowHeight defaultValue="723900">
<![CDATA[914400,1104900,723900,723900,1440000,723900,723900,723900,723900,723900,723900]]></RowHeight>
<ColumnWidth defaultValue="2743200">
<![CDATA[914400,2023200,1676400,1728000,4320000,0,2743200,2743200,2743200,2743200,2743200]]></ColumnWidth>
<CellElementList>
<C c="0" r="0" cs="2" s="0">
<O>
<![CDATA[今日工单]]></O>
...
<RowPrivilegeControl/>
<RowHeight defaultValue="723900">
<![CDATA[914400,1257300,723900,723900,723900,723900,723900,723900,723900,723900,723900]]></RowHeight>
<ColumnWidth defaultValue="2743200">
<![CDATA[914400,2743200,2743200,2743200,2743200,2743200,2743200,2743200,2743200,2743200,2743200]]></ColumnWidth>
<CellElementList>
<C c="0" r="0" cs="2" s="0">
<O>
<![CDATA[当日工单量]]></O>
...
<StyleList>
<Style horizontal_alignment="2" imageLayout="1">
<FRFont name="微软雅黑" style="0" size="72" foreground="-8355840"/>
<Background name="NullBackground"/>
<Border/>
</Style>
<Style horizontal_alignment="0" imageLayout="1">
<FRFont name="SimSun" style="1" size="176" foreground="-16711936"/>
<Background name="NullBackground"/>
<Border/>
</Style>
<Style horizontal_alignment="0" imageLayout="1">
...
<BoundsAttr x="331" y="43" width="220" height="113"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
...
<BoundsAttr x="551" y="43" width="212" height="113"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
...
<O t="DSColumn">
<Attributes dsName="本月P1问题" columnName="工单数"/>
<Complex/>
<RG class="com.fr.report.cell.cellattr.core.group.FunctionGrouper"/>
<Parameters/>
</O>
...
<FRFont name="微软雅黑" style="1" size="384" foreground="-1552561"/>
</HighlightAction>
</Highlight>
</HighlightList>
<Expand dir="0"/>
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[="距上次发生P1工单已有" + 本月P1问题.select("距离发生") + "天"]]></Attributes>
</O>
<PrivilegeControl/>
<HighlightList>
<Highlight class="com.fr.report.cell.cellattr.highlight.DefaultHighlight">
...
<FRFont name="微软雅黑" style="0" size="72" foreground="-5197648"/>
<Background name="ColorBackground" color="-1"/>
<Border/>
</Style>
...
<BoundsAttr x="0" y="0" width="301" height="155"/>
</Widget>
<body class="com.fr.form.ui.ElementCaseEditor">
<WidgetName name="report8"/>
<WidgetAttr description="">
...
<RowPrivilegeControl/>
<RowHeight defaultValue="723900">
<![CDATA[723900,723900,723900,723900,914400,723900,723900,723900,723900,723900,723900]]></RowHeight>
<ColumnWidth defaultValue="2743200">
<![CDATA[1485900,2743200,2705100,2362200,1485900,2743200,2705100,2362200,2743200,2743200,2743200]]></ColumnWidth>
<CellElementList>
<C c="0" r="0" cs="3" s="0">
<O>
<![CDATA[今日P1事件发生次数]]></O>
...
<C c="0" r="4" cs="4" s="2">
<O>
<![CDATA[距上次发生P1事件已有5天]]></O>
<PrivilegeControl/>
<Expand/>
</C>
<C c="4" r="4" cs="4" s="2">
<O>
<![CDATA[距上次发生P1事件已有3天]]></O>
<PrivilegeControl/>
<Expand/>
</C>
</CellElementList>
...
<Style horizontal_alignment="0" imageLayout="1">
<FRFont name="微软雅黑" style="1" size="184" foreground="-16733531"/>
<Background name="NullBackground"/>
<Border/>
</Style>
<Style horizontal_alignment="0" imageLayout="1">
...
<BoundsAttr x="0" y="390" width="301" height="155"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
...
<TextAttr>
<Attr alignText="0">
<FRFont name="Verdana" style="0" size="64" foreground="-5197648"/>
</Attr>
</TextAttr>
<AxisLabelCount value="=1"/>
<AxisRange/>
...
<AttrBackground>
<Background name="ColorBackground" color="-16682338"/>
<Attr shadow="false"/>
</AttrBackground>
</Attr>
</AttrList>
...
<Attr class="com.fr.chart.base.AttrBackground">
<AttrBackground>
<Background name="ColorBackground" color="-1797739"/>
<Attr shadow="false"/>
</AttrBackground>
</Attr>
</AttrList>
...
<Attr class="com.fr.plugin.chart.base.VanChartAttrTrendLine">
<TrendLine>
<Attr trendLineName="" trendLineType="exponential" prePeriod="8" afterPeriod="0"/>
<LineStyleInfo>
<AttrAlpha>
<Attr alpha="1.0"/>
</AttrAlpha>
...
<Attr class="com.fr.chart.base.AttrBackground">
<AttrBackground>
<Background name="ColorBackground" color="-7158084"/>
<Attr shadow="false"/>
</AttrBackground>
</Attr>
</AttrList>
...
<BoundsAttr x="331" y="0" width="654" height="234"/>
</Widget>
...
<TextAttr>
<Attr alignText="0">
<FRFont name="微软雅黑" style="0" size="64" foreground="-8355840"/>
</Attr>
</TextAttr>
<TitleVisible value="true" position="2"/>
</Title>
...
<BoundsAttr x="331" y="156" width="654" height="234"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
...
<FRFont name="微软雅黑" style="0" size="64" foreground="-3355444"/>
</Legend>
<Attr4VanChart floating="false" x="0.0" y="0.0" limitSize="false" maxHeight="15.0" isHighlight="true"/>
</Legend4VanChart>
<DataSheet>
...
<isCustomFillStyle isCustomFillStyle="true"/>
<ColorList>
<OColor colvalue="-16747616"/>
<OColor colvalue="-8270907"/>
<OColor colvalue="-4363512"/>
<OColor colvalue="-16750485"/>
<OColor colvalue="-3658447"/>
<OColor colvalue="-10331231"/>
...
<CategoryName value="times"/>
<ChartSummaryColumn name="this_gdl" function="com.fr.data.util.function.SumFunction" customName="2017"/>
<ChartSummaryColumn name="last_gdl" function="com.fr.data.util.function.SumFunction" customName="2016"/>
</MoreNameCDDefinition>
</ChartDefinition>
</Chart>
<tools hidden="true" sort="false" export="false" fullScreen="false"/>
...
<BoundsAttr x="985" y="0" width="316" height="347"/>
</Widget>
<body class="com.fr.form.ui.ChartEditor">
<WidgetName name="chart2"/>
<WidgetAttr description="">
...
<TextAttr>
<Attr alignText="0">
<FRFont name="微软雅黑" style="0" size="80" foreground="-8355840"/>
</Attr>
</TextAttr>
<TitleVisible value="true" position="2"/>
</Title>
...
<BoundsAttr x="985" y="43" width="316" height="347"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
...
<Margin top="0" left="0" bottom="0" right="0"/>
<Border>
<border style="0" color="-723724" borderRadius="50" type="0" borderStyle="0"/>
<WidgetTitle>
<O>
<![CDATA[新建标题]]></O>
<FRFont name="宋体" style="0" size="72"/>
...
<Attr class="com.fr.chart.base.AttrBackground">
<AttrBackground>
<Background name="ColorBackground" color="-13456166"/>
<Attr shadow="false"/>
</AttrBackground>
</Attr>
</AttrList>
...
<Attr class="com.fr.chart.base.AttrBackground">
<AttrBackground>
<Background name="ColorBackground" color="-8533061"/>
<Attr shadow="false"/>
</AttrBackground>
</Attr>
</AttrList>
...
<isCustomFillStyle isCustomFillStyle="true"/>
<ColorList>
<OColor colvalue="-15829859"/>
<OColor colvalue="-1077874"/>
<OColor colvalue="-13521701"/>
...
<BoundsAttr x="0" y="0" width="331" height="347"/>
</Widget>
<body class="com.fr.form.ui.ChartEditor">
<WidgetName name="chart5"/>
<WidgetAttr description="">
...
<Attr class="com.fr.chart.base.AttrBackground">
<AttrBackground>
<Background name="ColorBackground" color="-285546"/>
<Attr shadow="false"/>
</AttrBackground>
</Attr>
</AttrList>
...
<Attr class="com.fr.chart.base.AttrBackground">
<AttrBackground>
<Background name="ColorBackground" color="-136044"/>
<Attr shadow="false"/>
</AttrBackground>
</Attr>
</AttrList>
...
<Attr class="com.fr.chart.base.AttrBackground">
<AttrBackground>
<Background name="ColorBackground" color="-8393827"/>
<Attr shadow="false"/>
</AttrBackground>
</Attr>
</AttrList>
...
<DataProcessor class="com.fr.base.chart.chartdata.model.NormalDataModel"/>
<ChartDefinition>
<OneValueCDDefinition seriesName="question_type" valueName="value" function="com.fr.data.util.function.NoneFunction">
<Top topCate="-1" topValue="-1" isDiscardOtherCate="false" isDiscardOtherSeries="false" isDiscardNullCate="false" isDiscardNullSeries="false"/>
<TableData class="com.fr.data.impl.NameTableData">
<Name>
<![CDATA[工单分类]]></Name>
...
<BoundsAttr x="0" y="43" width="331" height="347"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
...
<Attr class="com.fr.chart.base.AttrBackground">
<AttrBackground>
<Background name="ColorBackground" color="-7613490"/>
<Attr shadow="false"/>
</AttrBackground>
</Attr>
</AttrList>
...
<Attr class="com.fr.chart.base.AttrBackground">
<AttrBackground>
<Background name="ColorBackground" color="-15895397"/>
<Attr shadow="false"/>
</AttrBackground>
</Attr>
</AttrList>
...
<Attr class="com.fr.chart.base.AttrBackground">
<AttrBackground>
<Background name="ColorBackground" color="-1274224"/>
<Attr shadow="false"/>
</AttrBackground>
</Attr>
</AttrList>
...
<DataProcessor class="com.fr.base.chart.chartdata.model.NormalDataModel"/>
<ChartDefinition>
<OneValueCDDefinition valueName="工单量" function="com.fr.data.util.function.NoneFunction">
<Top topCate="-1" topValue="-1" isDiscardOtherCate="false" isDiscardOtherSeries="false" isDiscardNullCate="false" isDiscardNullSeries="false"/>
<TableData class="com.fr.data.impl.NameTableData">
<Name>
<![CDATA[工单地区]]></Name>
...
<BoundsAttr x="985" y="0" width="316" height="308"/>
</Widget>
<body class="com.fr.form.ui.ChartEditor">
<WidgetName name="chart4"/>
<WidgetAttr description="">
...
<BoundsAttr x="985" y="390" width="316" height="308"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
...
<Attr class="com.fr.chart.base.AttrBorder">
<AttrBorder>
<Attr lineStyle="5" isRoundBorder="true" roundRadius="0"/>
<newColor borderColor="-15761491"/>
</AttrBorder>
</Attr>
<Attr class="com.fr.chart.base.AttrBackground">
<AttrBackground>
<Background name="ColorBackground" color="-15761491"/>
<Attr shadow="false"/>
</AttrBackground>
</Attr>
</AttrList>
...
<Attr class="com.fr.chart.base.AttrBackground">
<AttrBackground>
<Background name="ColorBackground" color="-485994"/>
<Attr shadow="false"/>
</AttrBackground>
</Attr>
</AttrList>
...
<DataProcessor class="com.fr.base.chart.chartdata.model.NormalDataModel"/>
<ChartDefinition>
<OneValueCDDefinition seriesName="times_type" valueName="工单量" function="com.fr.data.util.function.SumFunction">
<Top topCate="-1" topValue="-1" isDiscardOtherCate="false" isDiscardOtherSeries="false" isDiscardNullCate="false" isDiscardNullSeries="false"/>
<TableData class="com.fr.data.impl.NameTableData">
<Name>
<![CDATA[工单故障分析-月度环比]]></Name>
</TableData>
<CategoryName value="CAUSE_CATEGORY_LV1_NAME"/>
</OneValueCDDefinition>
</ChartDefinition>
</Chart>
<tools hidden="true" sort="false" export="false" fullScreen="false"/>
...
<BoundsAttr x="641" y="0" width="344" height="308"/>
</Widget>
<body class="com.fr.form.ui.ChartEditor">
<WidgetName name="chart1"/>
<WidgetAttr description="">
...
<BoundsAttr x="641" y="390" width="344" height="308"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
...
<C c="1" r="1" cs="2" rs="6" s="2">
<O t="DSColumn">
<Attributes dsName="本月P2问题" columnName="工单数"/>
<Complex/>
<RG class="com.fr.report.cell.cellattr.core.group.FunctionGrouper"/>
<Parameters/>
</O>
...
<BoundsAttr x="0" y="0" width="301" height="153"/>
</Widget>
<body class="com.fr.form.ui.ElementCaseEditor">
<WidgetName name="report0"/>
<WidgetAttr description="">
...
<RowPrivilegeControl/>
<RowHeight defaultValue="723900">
<![CDATA[723900,720000,720000,720000,720000,720000,720000,1028700,723900,723900,723900]]></RowHeight>
<ColumnWidth defaultValue="2743200">
...
<BoundsAttr x="0" y="545" width="301" height="153"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
...
<Attr class="com.fr.chart.base.AttrBackground">
<AttrBackground>
<Background name="ColorBackground" color="-881780"/>
<Attr shadow="false"/>
</AttrBackground>
</Attr>
</AttrList>
...
<Attr class="com.fr.chart.base.AttrBackground">
<AttrBackground>
<Background name="ColorBackground" color="-8336444"/>
<Attr shadow="false"/>
</AttrBackground>
</Attr>
</AttrList>
...
<Attr class="com.fr.chart.base.AttrBackground">
<AttrBackground>
<Background name="ColorBackground" color="-405630"/>
<Attr shadow="false"/>
</AttrBackground>
</Attr>
</AttrList>
...
<DataProcessor class="com.fr.base.chart.chartdata.model.NormalDataModel"/>
<ChartDefinition>
<OneValueCDDefinition seriesName="当前分配组" valueName="未解决工单" function="com.fr.data.util.function.SumFunction">
<Top topCate="-1" topValue="-1" isDiscardOtherCate="false" isDiscardOtherSeries="false" isDiscardNullCate="false" isDiscardNullSeries="false"/>
<TableData class="com.fr.data.impl.NameTableData">
<Name>
<![CDATA[服务单分配组]]></Name>
...
<BoundsAttr x="301" y="0" width="340" height="308"/>
</Widget>
<body class="com.fr.form.ui.ChartEditor">
<WidgetName name="chart3"/>
<WidgetAttr description="">
...
<DataProcessor class="com.fr.base.chart.chartdata.model.NormalDataModel"/>
<ChartDefinition>
<OneValueCDDefinition valueName="未解决工单" function="com.fr.data.util.function.SumFunction">
<Top topCate="-1" topValue="-1" isDiscardOtherCate="false" isDiscardOtherSeries="false" isDiscardNullCate="false" isDiscardNullSeries="false"/>
<TableData class="com.fr.data.impl.NameTableData">
<Name>
<![CDATA[服务单分配组]]></Name>
