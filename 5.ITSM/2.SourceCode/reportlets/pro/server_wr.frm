...
WHERE 1=1 ${if(len(sdate)==0,"","and stime>='"+sdate+"'")}
          ${if(len(sdate)==0,"","and stime<='"+edate+"'")}
  GROUP  BY  a.PROGNAME
...
<BoundsAttr x="506" y="16" width="80" height="21"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
...
<BoundsAttr x="50" y="16" width="80" height="21"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
...
<BoundsAttr x="130" y="16" width="105" height="21"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.Label">
...
<BoundsAttr x="247" y="16" width="80" height="21"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.DateEditor">
...
<BoundsAttr x="327" y="16" width="111" height="21"/>
</Widget>
<Sorted sorted="false"/>
...
<WidgetNameTagMap>
<NameTag name="sdate" tag="起始日期:"/>
<NameTag name="edate" tag="截止日期:"/>
</WidgetNameTagMap>
</North>
