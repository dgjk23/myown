...
<Query>
<![CDATA[select * from (
select top 5 REPORT_DATE,LEFT(INCIDENT_PRIORITY_NAME,2)as INCIDENT_PRIORITY_NAME,
...
,'【'+left(convert(nvarchar(300),REPORT_DATE),16)+'】'+convert(nvarchar(300),SYMPTOM) AS SYMPTOM


from ITSM_WorkOrder_Sync_test where 1=1 and  INCIDENT_STATUS<>7 and datediff(HOUR,REPORT_DATE,getdate())<=5 order by NEWID() ) as TTT
order by TTT.REPORT_DATE desc]]></Query>
</TableData>
...
from ITSM_WorkOrder_Sync_test where datediff(day,REPORT_DATE,getdate())=0 and  INCIDENT_STATUS<>7
...
<Attr isNullValueBreak="true" autoRefreshPerSecond="900" seriesDragEnable="false" plotStyle="4" combinedSize="50.0"/>
<newHotTooltipStyle>
<AttrContents>
...
<BoundsAttr x="0" y="0" width="240" height="236"/>
</Widget>
...
<BoundsAttr x="0" y="41" width="240" height="237"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
...
<BoundsAttr x="240" y="36" width="480" height="440"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
...
<BoundsAttr x="240" y="41" width="480" height="478"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
...
<BoundsAttr x="240" y="36" width="480" height="204"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.Label">
...
<BoundsAttr x="240" y="519" width="480" height="244"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
...
<Attr class="com.fr.plugin.chart.base.VanChartAttrMarker">
<VanAttrMarker>
<Attr isCommon="true" markerType="RoundFilledMarker" radius="3.5" width="30.0" height="30.0" color="-65536"/>
<Background name="NullBackground"/>
</VanAttrMarker>
</Attr>
</AttrList>
...
<![CDATA[值]]></CNAME>
<Compare op="0">
<SimpleDSColumn dsName="今日工单最大值" columnName="maxthis"/>
</Compare>
</Condition>
</ConditionAttr>
</List>
...
<BoundsAttr x="720" y="0" width="355" height="240"/>
</Widget>
<body class="com.fr.form.ui.ChartEditor">
<WidgetName name="chart3"/>
<WidgetAttr description="">
...
<BoundsAttr x="720" y="519" width="357" height="244"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
...
<BoundsAttr x="720" y="0" width="355" height="311"/>
</Widget>
<body class="com.fr.form.ui.ChartEditor">
<WidgetName name="chart4"/>
<WidgetAttr description="">
...
<BoundsAttr x="720" y="41" width="357" height="312"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
...
<ColumnWidth defaultValue="2743200">
<![CDATA[6286500,12420600,2743200,2743200,2743200,2743200,2743200,2743200,2743200,2743200,2743200]]></ColumnWidth>
<CellElementList>
<C c="0" r="0" s="0">
<O t="Formula" class="Formula">
<Attributes>
...
<BoundsAttr x="0" y="0" width="1075" height="41"/>
</Widget>
<body class="com.fr.form.ui.ElementCaseEditor">
<WidgetName name="report2"/>
<WidgetAttr description="">
...
<BoundsAttr x="0" y="0" width="1077" height="41"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
...
<BoundsAttr x="720" y="36" width="355" height="129"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.Label">
...
<BoundsAttr x="0" y="0" width="355" height="36"/>
</Widget>
<title class="com.fr.form.ui.Label">
<WidgetName name="Title_report1"/>
<WidgetAttr description="">
...
<BoundsAttr x="720" y="353" width="357" height="166"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
...
<BoundsAttr x="0" y="0" width="240" height="240"/>
</Widget>
<body class="com.fr.form.ui.ChartEditor">
<WidgetName name="chart0"/>
<WidgetAttr description="">
...
<BoundsAttr x="0" y="278" width="240" height="241"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
...
<BoundsAttr x="0" y="519" width="240" height="244"/>
</Widget>
<Sorted sorted="false"/>
<MobileWidgetList>
