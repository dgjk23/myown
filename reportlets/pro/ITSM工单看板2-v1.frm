...
SELECT top 8 
		...
		,case  when  sum(A.工单量)=0  then  0  else convert(decimal(18,4),convert(decimal(18,4),sum(A.工单量)-sum(A.未解决))/convert(decimal(18,4),sum(A.工单量)))  end  as  完成率
FROM   V_GDQYFX_GDFLZB  A
where  A.times_type='本月'
group    by  A.times_type,A.service_category_lv3_name 
order    by  sum(A.工单量)  desc ) as aaa
order by aaa.工单量 desc]]></Query>
</TableData>
...
sum(a.未完成)  未完成,
sum(a.工单量)  工单量,
case  when  sum(a.工单量)=0  then  0  else  convert(decimal(18,4),convert(decimal(18,4),sum(a.达标))/convert(decimal(18,4),sum(a.工单量)))   end  as  完成率,
sum(a.同期达标) 同期达标,
sum(a.同期未完成) 同期未完成,
sum(a.同期工单量) 同期工单量
from  ETL_GDFWQK_GDFWDQFX  a
left  join  TB_SimulatedGeographyNew   b on  (a.AddressCh=b.AddressCh)
where  substring(a.months,1,4)=convert(varchar(4),getdate(),121)
group  by a.months,a.owner_orgname
...
<Attr4VanChart floating="true" x="75.0" y="70.0" limitSize="false" maxHeight="15.0" isHighlight="false"/>
...
<BoundsAttr x="0" y="36" width="450" height="501"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
...
<Attributes>
<![CDATA[=' '+'各地区用户提报服务单未完成率分布']]></Attributes>
</O>
</widgetValue>
...
<BoundsAttr x="0" y="0" width="450" height="537"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
...
<BoundsAttr x="450" y="36" width="266" height="160"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.Label">
...
<BoundsAttr x="450" y="0" width="266" height="196"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
...
<BoundsAttr x="450" y="36" width="507" height="171"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.Label">
...
<BoundsAttr x="0" y="0" width="507" height="36"/>
</Widget>
<title class="com.fr.form.ui.Label">
<WidgetName name="Title_chart2"/>
<WidgetAttr description="">
...
<BoundsAttr x="450" y="330" width="507" height="207"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
...
<BoundsAttr x="716" y="36" width="241" height="160"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.Label">
...
<BoundsAttr x="716" y="0" width="241" height="196"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
...
<BoundsAttr x="450" y="0" width="507" height="134"/>
</Widget>
...
<BoundsAttr x="450" y="196" width="507" height="134"/>
</Widget>
<Sorted sorted="false"/>
